...
<<<<<<< HEAD:static/js/claire_geoplotting_youtube_v2_nov_multi.js
d3.csv('/nov_data').then(data => {
=======
d3.csv('/YouTube - Nov 2022').then(data => {
>>>>>>> 0379980c3cf19d390bb94e1a1d0837e531838709:Flask Application/static/js/claire_geoplotting_youtube_v2_nov_multi.js
    console.log(data);
